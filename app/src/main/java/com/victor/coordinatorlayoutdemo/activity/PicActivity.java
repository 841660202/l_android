...
import com.victor.coordinatorlayoutdemo.adapter.GridImageAdapter;
import com.victor.coordinatorlayoutdemo.behavior.FullyGridLayoutManager;
            ...
            public void onItemClick(int position, View v) {
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            // 预览图片 可自定长按保存路径
                            //PictureSelector.create(PicActivity.this).externalPicturePreview(position, "/custom_file", selectList);
