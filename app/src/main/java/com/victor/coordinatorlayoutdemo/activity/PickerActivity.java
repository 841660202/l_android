...
import com.victor.coordinatorlayoutdemo.activity.JsonDataActivity;
import com.victor.coordinatorlayoutdemo.bean.CardBean;
import com.victor.coordinatorlayoutdemo.bean.ProvinceBean;
...
public class PickerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assert btn_no_linkage != null;
        btn_no_linkage.setOnClickListener(this);
        assert btn_to_Fragment != null;
        ...
        btn_lunar.setOnClickListener(this);
    }
    ...
    private void initLunarPicker() {
        ...
        pvCustomLunar = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                btn_lunar.setText(getTime(date, "yyyy-MM-dd"));
...
//        pvOptions.setSelectOptions(1,1);
    ...
    private String getTime(Date date, String f) {//可根据需要自行截取数据显示
