...
public class WaterFallFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_water_fall, container, false);
...
//        textView1.setTextColor(Color.YELLOW);
    ...
    class MyAdapter extends RecyclerView.Adapter<WaterFallFragment.MyViewHolder> {
        ...
        @Override
        public WaterFallFragment.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = View.inflate(getContext(), R.layout.list_item_water_fall, null);
            WaterFallFragment.MyViewHolder viewHolder = new WaterFallFragment.MyViewHolder(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(final WaterFallFragment.MyViewHolder holder, final int position) {
